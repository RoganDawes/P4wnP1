...
sudo cp duckhid.sh /usr/bin/duckhid
sudo cp outhid.sh /usr/bin/outhid
sudo cp outmouse.sh /usr/bin/outmouse
sudo cp key_trigger.sh /usr/bin/key_trigger
sudo cp keyboardtest.sh /usr/bin/key_test
...
sudo chmod a+x /usr/bin/duckhid
sudo chmod a+x /usr/bin/outhid
sudo chmod a+x /usr/bin/outmouse
sudo chmod a+x /usr/bin/key_trigger
sudo chmod a+x /usr/bin/key_test
